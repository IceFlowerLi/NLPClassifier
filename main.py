...
parser.add_argument('-epochs', type=int, default=150, help='number of epochs for train [default: 256]')
...
parser.add_argument('-max-norm', type=float, default=10, help='l2 constraint of parameters [default: 3.0]')
...
def sst(text_field, label_field, **kargs):
    ...
    train_data, dev_data, test_data = mysst.MR.splits('./data/', 'train2', 'val2', 'test2',
    ...
    train_iter, dev_iter, test_iter = data.BucketIterator.splits(
        ...
        batch_sizes=(args.batch_size,
                     ...
                     len(test_data)),
        **kargs)
    # Add itos of vocab into args.
    args.itos = text_field.vocab.itos
...
if args.predict is not None:
    ...
    print()
    try:
        Train.train(train_iter, test_iter, dev_iter, cnn, args)
